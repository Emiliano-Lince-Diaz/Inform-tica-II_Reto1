...
- El programa detecta combinaciones de 3 o más fichas iguales en horizontal o vertical, las elimina, reorganiza el tablero (caída + relleno) y procesa cascadas automáticamente.
...
- Video de 5 a 11 minutos, sin IA, con participación explícita de todo el equipo (si aplica).
